...
class testClass(dgdiagBase):
    ...
    def prepareGpuCommands(self):
        ...
        if self.parsed_args.inst == -1:
            ...
            self.gpuCommands.append(f'{envVars}./DGDiagTool -PCIE.TEST.LMT inst={self.parsed_args.inst} p_range={self.parsed_args.p_range} p_step={self.parsed_args.p_step} d_range={self.parsed_args.d_range} d_step={self.parsed_args.d_step} lane_mask={self.parsed_args.lane_mask} itr={self.parsed_args.iterations}')
